...
<div class="header">
    ...
    <div class="home-header">
        <h1>Keuntungan Memilih BarberShop</h1>
    </div>
    <div class="gambar">
 ...
 <div class="container">
    <div class="content">
        <h2>1. Lebih dari sekedar potong rambut</h2>
        <p>Barbershop rata-rata memiliki pelayanan yang lebih lengkap dari sekadar potong rambut. Semua itu juga dikhususkan bagi pria. Selain mendapatkan potongan rambut terbaik dari ahlinya, pria juga bisa mengatur gaya janggut, kumis atau menerima rekomendasi perawatan rambut yang sesuai.</p>

        <img src="https://asset.kompas.com/crops/V6ViT5zjwooMiYHjl922Cl5FMOM=/0x0:0x0/750x500/data/photo/2022/06/29/62bc3c5f26d8d.jpg" alt="">
    </div>

    
    <div class="content">
       <h2>2. Model Rambut yang sesuai</h2>
       <p>Pelanggan yang datang bisa mendapatkan inspirasi melalui saran para kapster terkait model rambut yang sesuai dengan bentuk wajah atau kepribadian kita.</p>

       <img src="https://asset.kompas.com/crops/D_9ziJNPTcesJm3goA_d09EDUBA=/0x1:741x495/750x500/data/photo/2022/09/06/6316aab0cfbf9.jpg" alt="">
    </div>
 </div>
