    ...
    <div class="nav">
        ...
        <ul class="data-list">
            ...
            <a href="#"><li class="isi">Isi <i class="fa-solid fa-chevron-down"></i>
                ...
                <ul class="list">
                    <a href="keuntungan.php"><li>Keuntungan</li></a>
                    <a href="produk.php"><li>Produk yang ditawarkan</li></a>
                </ul>
                
            </li></a>
            <a href="layanan.php"><li>Layanan</li></a> 
            <a href="lokasi.php"><li>Lokasi</li></a> 
            <a href="aboutme.php"><li>AboutMe</li></a> 
        </ul>
...
<div class="header">
 ...
 <div class="container">
    <div class="content">
        <h2>1. Alat pemotong rambut</h2>
        <p>Salah satu faktor utama perbedaan barbershop dan pangkas rambut adalah alat pemotong rambut. Barbershop menyediakan alat modern untuk memotong rambut, seperti hair clipper yang membuat waktu memangkas rambut lebih singkat.

            Sebaliknya, mayoritas tempat pangkas rambut hanya bermodalkan cermin, gunting, dan sisir. Karenanya, waktu memotong rambut tergantung pada model gaya rambut yang diinginkan.</p>

        <img src="https://cdn.idntimes.com/content-images/post/20220629/allyson-carter-unxvqbcltcg-unsplash-53d39821b5a5bc873cfc93463314388c.png" alt="">
    </div>

    
    <div class="content">
       <h2>2. Layanan perawatan rambut</h2>
       <p>Barbershop dan pangkas rambut menyediakan layanan perawatan rambut pria yang berbeda. Perbedaan barbershop dan pangkas rambut ini tentunya mempengaruhi biaya yang perlu dikeluarkan untuk sekali perawatan rambut.
       ...
       <img src="https://cdn.idntimes.com/content-images/post/20220629/antonio-reynoso-25ixtaa6oy-unsplash-f0be3682daa94a83819724c3cc20376c.png" alt="">
    </div>
 </div>


 <div class="test">
 <p>Ingin Booking? klik aja disini!</p>
    </div>

 <a href="booking.php" class="btn-kembali">Booking</a>

<!-- container selesai -->

     <!-- footer -->
      <div class="bg-footer">
        <p>@2024 Louis Landing Page, All Rights Reserved</p>
      </div>
